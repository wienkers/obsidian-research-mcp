...
export class BatchReader {
    async readMultipleNotes(paths, options = { includeContent: true, includeMetadata: true }) {
    ...
    async getNoteSummaries(paths) {
        return this.readMultipleNotes(paths, {
            includeContent: false,
            includeMetadata: true
        });
    }
    async getFullNotes(paths) {
        return this.readMultipleNotes(paths, {
            includeContent: true,
            includeMetadata: true
        });
    ...
    async getContentPreview(paths, maxLength = 200) {
