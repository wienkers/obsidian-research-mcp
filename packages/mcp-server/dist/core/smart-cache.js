...
export class SmartCache {
     ...
     */
    async set(key, value, ttl = this.options.defaultTtl, dependencies = []) {
     ...
     */
    async evictToFitMemory(requiredSize) {
     ...
     * Update dependency mappings
     */
    updateDependencyMappings(key, dependencies) {
    ...
    estimateSize(obj) {
        ...
        if (typeof obj === 'object') {
            return Object.entries(obj).reduce((size, [key, value]) => size + this.estimateSize(key) + this.estimateSize(value), 24);
        }
