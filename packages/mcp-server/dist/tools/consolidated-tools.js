 ...
 */
export const CONSOLIDATED_OBSIDIAN_TOOLS = [
...
export function validateSemanticSearchParams(input) {
...
export function validatePatternSearchParams(input) {
...
export function validateLinkedToParams(linkedTo) {
    if (!linkedTo) {
        return [];
    }
